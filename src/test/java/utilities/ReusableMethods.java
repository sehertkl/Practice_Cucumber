...
public class ReusableMethods {
    ...
    public static void textIleClick(String text) {
    ...
    public static void loginPage(WebElement emailButton, String string, WebElement passwordButtonLogin, String string2) {
        ...
        passwordButtonLogin.sendKeys(string2);

    }

    public static void xpathIleIsDisplay(WebElement oge) {
        SkodaPage hepsiBPage = new SkodaPage();
        Assert.assertTrue(By.xpath(String.valueOf(oge)).findElement(Driver.getDriver()).isDisplayed());
        }
